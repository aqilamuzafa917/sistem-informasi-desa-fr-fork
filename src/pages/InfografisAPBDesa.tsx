import {
  ...
  export default function InfografisAPBDesa() {
    ...
    const dataPerbandinganTahunan = [
      { 
        ...
        belanjaDesa: [
          ...
          { kategori: "Penanggulangan Bencana, dan Keadaan Mendesak Desa", jumlah: 106145362 },
        ]
      },
      { 
        tahun: "2024", 
        ...
        belanjaDesa: [
          ...
          { kategori: "Penanggulangan Bencana, dan Keadaan Mendesak Desa", jumlah: 61292403 },
        ]
      },
      { 
        tahun: "2025", 
        ...
        belanjaDesa: [
          ...
          { kategori: "Penanggulangan Bencana, dan Keadaan Mendesak Desa", jumlah: 143978518 },
        ]
      },
    ];
  
    const selectedYearData = dataPerbandinganTahunan.find(data => data.tahun === selectedYear) || dataPerbandinganTahunan[2]; // Default ke 2025 jika tidak ditemukan
    ...
    const dataPendapatanDesa = [
      { kategori: "Pendapatan Asli Desa", jumlah: selectedYearData.pendapatanAsliDesa },
      { kategori: "Pendapatan Transfer", jumlah: selectedYearData.pendapatanTransfer },
      { kategori: "Pendapatan Lain-lain", jumlah: selectedYearData.pendapatanLainLain },
    ];
      ...
      <main className="min-h-screen bg-white dark:bg-gray-900">
        ...
        <Navbar fluid rounded className="mb-8 border-y-2">
          ...
          <NavbarCollapse>
            ...
            <NavbarLink href="/infografispenduduk" active>Infografis</NavbarLink>
        ...
        <div className="mb-8 flex flex-wrap justify-center gap-8">
          ...
          <div className="mb-8 flex flex-col md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-400">
                Desa {desaNama}, Kecamatan {kecamatan}, Kabupaten {kabupaten}, Provinsi {provinsi}
              </p>
            </div>
            <div className="mt-4 md:mt-0">
              <select 
                className="w-full md:w-auto bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg px-4 py-2 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
                value={selectedYear}
                onChange={(e) => {
          ...
          <div className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300">Pendapatan</h3>
              </div>
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300">Belanja</h3>
              </div>
          ...
          <div className="mb-8 rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            <h3 className="mb-4 text-xl font-bold text-gray-800 dark:text-white">Pembiayaan</h3>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div className="rounded-lg border border-gray-200 bg-gray-100 p-4 dark:border-gray-700 dark:bg-gray-900">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-lg font-semibold text-gray-700 dark:text-gray-300">Penerimaan</h4>
                </div>
              ...
              <div className="rounded-lg border border-gray-200 bg-gray-100 p-4 dark:border-gray-700 dark:bg-gray-900">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="text-lg font-semibold text-gray-700 dark:text-gray-300">Pengeluaran</h4>
                </div>
            ...
            <div className="mt-4 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
              <div className="flex items-center justify-between">
                <h4 className="text-lg font-semibold text-gray-700 dark:text-gray-300">Surplus/Defisit</h4>
        ...
        <Footer container className="rounded-none">
          <div className="w-full">
            ...
            <div className="w-full sm:flex sm:items-center sm:justify-between">
              <FooterCopyright href="/" by={`Desa ${desaNama}™`} year={2023} />
