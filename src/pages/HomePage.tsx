// This content is moved from the original App.tsx
// No DarkThemeToggle here, as it will be in App.tsx (layout)
...
export default function HomePage() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-white px-4 py-24 dark:bg-gray-900">
      ...
      {/* DarkThemeToggle is removed from here, will be in App.tsx */}
