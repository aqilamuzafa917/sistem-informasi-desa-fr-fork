                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    {[1, 2].map((i) => (
                      ...
                      >
                        ...
                        <div className="h-16 w-32 rounded-lg bg-gray-200 dark:bg-gray-700"></div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                    {[1, 2, 3].map((i) => (
                      ...
                      >
                        <div className="mb-4 flex items-center justify-between">
                          <div className="h-6 w-24 rounded-lg bg-gray-200 dark:bg-gray-700"></div>
                          <div className="h-10 w-10 rounded-full bg-gray-200 dark:bg-gray-700"></div>
                        </div>
                        <div className="h-12 w-24 rounded-lg bg-gray-200 dark:bg-gray-700"></div>
                        <div className="mt-4 h-2 w-full rounded-full bg-gray-200 dark:bg-gray-700"></div>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <>
                <div className="mb-8">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300">
                    Indikator pembangunan desa yang mencakup aspek sosial,
                    ekonomi, dan ekologi
                  </p>
                </div>
